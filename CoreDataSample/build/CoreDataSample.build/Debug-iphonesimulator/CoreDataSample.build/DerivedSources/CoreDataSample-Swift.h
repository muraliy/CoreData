...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CoreDataSample",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14CoreDataSample18HomeViewController")
@interface HomeViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified studentTable;
- (void)viewDidLoad;
- (void)addTapped;
...
@interface HomeViewController (SWIFT_EXTENSION(CoreDataSample)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC14CoreDataSample13SceneDelegate")
...
@interface Student (SWIFT_EXTENSION(CoreDataSample))
@property (nonatomic, copy) NSString * _Nullable name;
@property (nonatomic) int16_t age;
@property (nonatomic) int64_t roolnumber;
@end

@class UILabel;

SWIFT_CLASS("_TtC14CoreDataSample20StudentTableViewCell")
@interface StudentTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified nameLbl;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified rollnumLbl;
- (void)awakeFromNib;
...
@interface User (SWIFT_EXTENSION(CoreDataSample))
@property (nonatomic, copy) NSString * _Nullable name;
